...
place('C2', data={'ref': 'C2', 'x_mm': 47.0, 'y_mm': 39.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 4.243, 'courtyard_h_mm': 4.243, 'source': 'solver_decoupling_proximity', 'rationale': 'Cost solver placed C2 near decoupling target U1.'})
...
place('U1', data={'ref': 'U1', 'x_mm': 44.0, 'y_mm': 46.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 19.209, 'courtyard_h_mm': 19.209, 'source': 'solver_rf_edge_keepout', 'rationale': 'Cost solver moved U1 toward a board edge for integral antenna keepout.'})
