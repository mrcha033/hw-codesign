...
board = SemanticBoard(
    project='bench_robotics_controller_b204035a',
    revision='r1',
    purpose='LLM-suited schematic representation derived from typed graph; native EDA files are generated outputs.',
    source_graph='/Users/mrcha033/Documents/hw-cli/projects/bench_robotics_controller_b204035a/electronics/generated/electrical_graph.json',
...
place('J11', data={'ref': 'J11', 'x_mm': 3.0, 'y_mm': 7.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
place('J12', data={'ref': 'J12', 'x_mm': 3.0, 'y_mm': 22.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
place('J13', data={'ref': 'J13', 'x_mm': 3.0, 'y_mm': 37.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
place('J14', data={'ref': 'J14', 'x_mm': 3.0, 'y_mm': 52.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
place('J15', data={'ref': 'J15', 'x_mm': 3.0, 'y_mm': 67.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
place('J16', data={'ref': 'J16', 'x_mm': 3.0, 'y_mm': 82.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
place('J17', data={'ref': 'J17', 'x_mm': 157.0, 'y_mm': 7.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
place('J18', data={'ref': 'J18', 'x_mm': 157.0, 'y_mm': 22.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
place('J19', data={'ref': 'J19', 'x_mm': 157.0, 'y_mm': 37.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
...
place('J20', data={'ref': 'J20', 'x_mm': 157.0, 'y_mm': 52.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
place('J21', data={'ref': 'J21', 'x_mm': 157.0, 'y_mm': 67.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
place('J22', data={'ref': 'J22', 'x_mm': 157.0, 'y_mm': 82.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 7.348, 'courtyard_h_mm': 7.348, 'source': 'connector_edge_seed', 'rationale': 'Seed pushed to a board edge for connector access.'})
...
place('R1', data={'ref': 'R1', 'x_mm': 136.0, 'y_mm': 27.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 4.243, 'courtyard_h_mm': 4.243, 'source': 'curated_anchor', 'rationale': 'Hand-tuned anchor from the reference layout seed.'})
...
constraint(data={'kind': 'connector_edge', 'target_ref': 'J3', 'params': {'side': 'front', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J5', 'params': {'side': 'rear', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J2', 'params': {'side': 'rear', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J11', 'params': {'side': 'left', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J12', 'params': {'side': 'left', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J13', 'params': {'side': 'left', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J14', 'params': {'side': 'left', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J15', 'params': {'side': 'left', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J16', 'params': {'side': 'left', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J17', 'params': {'side': 'right', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J18', 'params': {'side': 'right', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J19', 'params': {'side': 'right', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J20', 'params': {'side': 'right', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J21', 'params': {'side': 'right', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
constraint(data={'kind': 'connector_edge', 'target_ref': 'J22', 'params': {'side': 'right', 'max_edge_distance_mm': 6.0}, 'derived_from': 'mechanical.connector_interfaces + mechanical.max_connector_edge_distance_mm', 'enforced': True, 'rationale': ''})
...
constraint(data={'kind': 'decoupling_proximity', 'target_ref': 'C3', 'params': {'power_nets': ['GND', 'V3V3']}, 'derived_from': 'graph decoupling component pins', 'enforced': False, 'rationale': 'Cap-to-IC association is not modelled in the netlist; proximity enforcement is deferred.'})
constraint(data={'kind': 'decoupling_proximity', 'target_ref': 'C4', 'params': {'power_nets': ['GND', 'V3V3']}, 'derived_from': 'graph decoupling component pins', 'enforced': False, 'rationale': 'Cap-to-IC association is not modelled in the netlist; proximity enforcement is deferred.'})
constraint(data={'kind': 'decoupling_proximity', 'target_ref': 'C5', 'params': {'power_nets': ['GND', 'V3V3']}, 'derived_from': 'graph decoupling component pins', 'enforced': False, 'rationale': 'Cap-to-IC association is not modelled in the netlist; proximity enforcement is deferred.'})
constraint(data={'kind': 'decoupling_proximity', 'target_ref': 'C6', 'params': {'power_nets': ['GND', 'V3V3']}, 'derived_from': 'graph decoupling component pins', 'enforced': False, 'rationale': 'Cap-to-IC association is not modelled in the netlist; proximity enforcement is deferred.'})
constraint(data={'kind': 'decoupling_proximity', 'target_ref': 'C7', 'params': {'power_nets': ['GND', 'V3V3']}, 'derived_from': 'graph decoupling component pins', 'enforced': False, 'rationale': 'Cap-to-IC association is not modelled in the netlist; proximity enforcement is deferred.'})
constraint(data={'kind': 'decoupling_proximity', 'target_ref': 'C8', 'params': {'power_nets': ['GND', 'V3V3']}, 'derived_from': 'graph decoupling component pins', 'enforced': False, 'rationale': 'Cap-to-IC association is not modelled in the netlist; proximity enforcement is deferred.'})
