...
board = SemanticBoard(
    ...
    source_graph='/Users/mrcha033/Documents/hw-cli/projects/bench_sensor_logger_usb_5eab0a5d/electronics/generated/electrical_graph.json',
    board_width_mm=70.0,
...
place('D1', data={'ref': 'D1', 'x_mm': 30.0, 'y_mm': 10.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 6.708, 'courtyard_h_mm': 6.708, 'source': 'sensor_data_logger_anchor', 'rationale': ''})
place('F1', data={'ref': 'F1', 'x_mm': 26.0, 'y_mm': 4.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 4.243, 'courtyard_h_mm': 4.243, 'source': 'sensor_data_logger_anchor', 'rationale': ''})
place('J1', data={'ref': 'J1', 'x_mm': 18.0, 'y_mm': 4.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 6.0, 'courtyard_h_mm': 6.0, 'source': 'sensor_data_logger_anchor', 'rationale': ''})
place('J2', data={'ref': 'J2', 'x_mm': 58.0, 'y_mm': 44.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 6.708, 'courtyard_h_mm': 6.708, 'source': 'sensor_data_logger_anchor', 'rationale': ''})
place('Q1', data={'ref': 'Q1', 'x_mm': 34.0, 'y_mm': 4.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 5.196, 'courtyard_h_mm': 5.196, 'source': 'sensor_data_logger_anchor', 'rationale': ''})
...
place('U1', data={'ref': 'U1', 'x_mm': 44.0, 'y_mm': 44.0, 'rotation_deg': 0.0, 'side': 'top', 'courtyard_w_mm': 10.817, 'courtyard_h_mm': 10.817, 'source': 'sensor_data_logger_anchor', 'rationale': ''})
...
constraint(data={'kind': 'decoupling_proximity', 'target_ref': 'C1', 'params': {'power_nets': ['GND', 'V3V3'], 'target_ref': 'U1', 'max_distance_mm': 12.0}, 'derived_from': 'graph decoupling component pins + decoupling_target_ref', 'enforced': True, 'rationale': ''})
