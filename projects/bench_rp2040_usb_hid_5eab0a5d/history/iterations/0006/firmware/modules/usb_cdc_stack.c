/* Generated module: usb_cdc_stack - behavior: interface_stack
...
#include <stddef.h>
#include "pinmap.h"
#include "usb_cdc_stack.h"

#if !defined(PIN_USB_DP)
#error "usb_cdc_stack requires firmware pinmap signal USB_DP"
#endif
#if !defined(PIN_USB_DM)
#error "usb_cdc_stack requires firmware pinmap signal USB_DM"
#endif

static const char *const usb_cdc_stack_required_nets[] = {
    "USB_DP",
    "USB_DM",
};

static const char *const usb_cdc_stack_required_tests[] = {
    "usb_cdc_enumeration",
};
...
{
    return usb_cdc_stack_required_nets;
}

const char *const *usb_cdc_stack_required_tests_ptr(void)
{
    return usb_cdc_stack_required_tests;
}
