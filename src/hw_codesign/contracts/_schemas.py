            ...
            "compiler_ir": {
                ...
                "properties": {
                    ...
                    "resolved_assumptions": {
                        ...
                        "items": {
                            "type": "object",
                            "required": ["assumption_key", "value", "status", "source_span", "source_range", "spec_path", "affected_gates"],
                            "additionalProperties": True,
                            "properties": {
                                ...
                                "spec_path":               {"type": "string"},
                                "affected_gates":          {"type": "array", "items": {"type": "string"}},
                                "required_human_approvals": {"type": "array", "items": {"type": "string"}, "maxItems": 0},
                                "reason":                  {"type": "string"},
                            },
                        },
                    },
                    ...
                    "conflicting_fields": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "source_span":              {"type": "string"},
                                "source_range":             deepcopy(_SOURCE_RANGE),
                                "category":                 {"type": "string", "const": "conflicting_requirement"},
                                "field_type":               {"type": "string", "const": "conflicting_lowered_field"},
                                "status":                   {"type": "string", "const": "unresolved"},
                                "release_blocking":         {"type": "boolean", "const": True},
                                "reason":                   {"type": "string"},
                                "spec_path":                {"type": "string"},
                                "conflicts":                {"type": "array", "items": {"type": "object", "additionalProperties": True}, "minItems": 2},
                                "required_human_approvals": {"type": "array", "items": {"type": "string"}, "minItems": 1},
                                "affected_gates":           {"type": "array", "items": {"type": "string"}, "minItems": 1},
                            },
                        },
                    ...
                    "tokens": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                "id":                       {"type": "string"},
                                "kind":                     {"type": "string", "enum": ["lowered_field", "unsupported_constraint", "conflicting_lowered_field", "retained_assumption"]},
                                "status":                   {"type": "string"},
                                "source_span":              {"type": ["string", "null"]},
                                "source_range":             deepcopy(_NULLABLE_SOURCE_RANGE),
                                "release_blocking":         {"type": "boolean"},
