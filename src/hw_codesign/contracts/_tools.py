...
TOOL_REGISTRY: dict[str, ToolDef] = {
    ...
    "hw_run_grounding_benchmark": ToolDef(
        ...
        description=(
            ...
            "Injects in-memory wrong pinout, wrong footprint, exact-part no-connect pin contract violations, missing or miswired support circuit including USB-C CC Rd and crystal load caps, bad power budget, "
            "unreachable power rail, regulator voltage-order violation, regulator input voltage range violation, missing rail decoupling, missing or wrong-rail I2C pull-up, missing or wrong-value CAN termination, "
