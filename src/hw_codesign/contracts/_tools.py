...
TOOL_REGISTRY: dict[str, ToolDef] = {
    ...
    "hw_run_grounding_benchmark": ToolDef(
        ...
        description=(
            ...
            "unreachable power rail, regulator voltage-order violation, regulator input voltage range violation, missing rail decoupling, missing or wrong-rail I2C pull-up, missing CAN termination, "
