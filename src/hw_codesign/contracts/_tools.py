...
TOOL_REGISTRY: dict[str, ToolDef] = {
    ...
    "hw_update_requirements": ToolDef(
        ...
        description="Compile natural-language requirements text into typed spec fields, including explicit vibration environment, plus resolved assumptions, unresolved assumptions, unsupported qualification constraints, required approvals, and affected gates.",
        input_schema={
            "type": "object",
            "properties": {
                "project":           {"type": "string"},
    ...
    "hw_run_grounding_benchmark": ToolDef(
        ...
        description=(
            ...
            "Injects in-memory wrong pinout, wrong footprint, exact-part no-connect pin contract violations, missing or miswired support circuit including USB-C CC Rd, USB ESD pair mapping, crystal load-cap presence/grounding/value, boot strap bias, and status-LED device/polarity/current limiting, bad power budget, "
