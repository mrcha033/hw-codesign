...
def create_server(root: Path | str | None = None):
    ...
    @_tool(name=_TR["hw_compare_iterations"].name)
    ...
    @_tool(name=_TR["hw_update_requirements"].name)
    ...
    @_tool(name=_TR["hw_list_assumptions"].name)
    ...
    @_tool(name=_TR["hw_resolve_assumption"].name)
    ...
    @_tool(name=_TR["hw_generate_all"].name)
    ...
    @_tool(name=_TR["hw_generate_reference_intent"].name)
    ...
    @_tool(name=_TR["hw_generate_mechanical"].name)
    ...
    @_tool(name=_TR["hw_generate_firmware"].name)
    ...
    @_tool(name=_TR["hw_check_electrical_semantics"].name)
    ...
    @_tool(name=_TR["hw_extract_electrical_graph"].name)
    ...
    @_tool(name=_TR["hw_export_pcb_fabrication"].name)
    ...
    @_tool(name=_TR["hw_check_mechanical_fit"].name)
    ...
    @_tool(name=_TR["hw_import_board_step"].name)
    ...
    @_tool(name=_TR["hw_export_mechanical"].name)
    ...
    @_tool(name=_TR["hw_check_pinmap"].name)
    ...
    @_tool(name=_TR["hw_build_firmware"].name)
    ...
    @_tool(name=_TR["hw_generate_bringup_tests"].name)
    ...
    @_tool(name=_TR["hw_run_all_checks"].name)
    ...
    @_tool(name=_TR["hw_generate_repair_plan"].name)
    ...
    @_tool(name=_TR["hw_design_candidate"].name)
    ...
    @_tool(name=_TR["hw_explore_design_space"].name)
    ...
    @_tool(name=_TR["hw_run_grounding_benchmark"].name)
    def run_grounding_benchmark(project: str) -> dict[str, Any]:
        return service.run_grounding_benchmark(project)

    @_tool(name=_TR["hw_generate_physical_qualification_plan"].name)
    ...
    @_tool(name=_TR["hw_record_physical_evidence"].name)
    ...
    @_tool(name=_TR["hw_run_design_iteration"].name)
    ...
    @_tool(name=_TR["hw_run_design_benchmark"].name)
    ...
    @_tool(name=_TR["hw_design_until_release"].name)
    ...
    @_tool(name=_TR["hw_check_release_gate"].name)
    ...
    @_tool(name=_TR["hw_prepare_fabrication_review"].name)
    ...
    @_tool(name=_TR["hw_diagnose_environment"].name)
    ...
    @_tool(name=_TR["hw_export_release_bundle"].name)
    ...
    @_tool(name=_TR["hw_verify_release"].name)
    ...
    @_tool(name=_TR["hw_design_part"].name)
    ...
    @_tool(name=_TR["hw_design_firmware_module"].name)
    ...
    @_tool(name=_TR["hw_list_firmware_modules"].name)
    ...
    @_tool(name=_TR["hw_get_firmware_behavior_library"].name)
    ...
    @_tool(name=_TR["hw_propose_circuit_block"].name)
    ...
    @_tool(name=_TR["hw_add_circuit_block"].name)
    ...
    @_tool(name=_TR["hw_list_circuit_blocks"].name)
    ...
    @_tool(name=_TR["hw_set_placement_constraint"].name)
    ...
    @_tool(name=_TR["hw_list_placement_constraints"].name)
    ...
    @_tool(name=_TR["hw_record_design_decision"].name)
    ...
    @_tool(name=_TR["hw_check_cross_domain_consistency"].name)
    ...
    @_tool(name=_TR["hw_share_review"].name)
    ...
    @_tool(name=_TR["hw_add_review_comment"].name)
    ...
    @_tool(name=_TR["hw_list_review_comments"].name)
