...
- `hw_run_grounding_benchmark` — adversarial check over pinout, footprint, support circuits, power tree, layout, RF, sourcing, firmware modules, and dependency order
